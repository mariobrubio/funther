      ...
      <v-layout row wrap>
        <v-flex lg12>
            <div class="text-xs-center">
              <v-parallax src="/static/bg/33.jpg" height="700">
                  ...
                  <v-flex d-flex xs12 sm6 md4>
                    <v-card color="blue-grey darken-4" class="white--text">
                      <v-card-title primary-title>
                        <div>
                          <div class="headline">Flexión de Rodilla 2</div>
                          <span>Sentado y con un rodillo o toalla bajo la rodilla, se eleva la pierna lentamente todo lo que se pueda y se devuelve a la posición inicial.</span><br>
                          <span>10 repeticiones en el menor tiempo posible.</span>
                        </div>
                      </v-card-title>
                      <v-card-media src="/static/videos/rodilla2.gif" height="350">
                      </v-card-media>     
                      <div class="text-xs-center">
                        <v-progress-linear
                          v-model="value"
                            ...
                            <v-card>
                              <v-card-text>
                                <v-alert
                                  ...
                                  >
                                    Has terminado, ¡Desbloqueaste el segundo track de tu canción!. Dale Play y escuchalo.
                    ...
                    <v-layout v-else key="1" justify-center align-center>
                      ...
                      <v-card-media src="/static/rodilla2.png" height="350">
                      </v-card-media>
  ...
  components: {
    VWidget
      ...
      return {
        ...
        counter: 0,
        items: [
          { active: true, title: 'Back in Black', avatar: 'https://cdn.vuetifyjs.com/images/lists/1.jpg', file: new Audio('static/funther_FS1.mp3'),
            isPlaying: false }
        ]
      }
    },
