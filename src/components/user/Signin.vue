        ...
        <v-card>
          <v-container>
            ...
            <v-avatar size="75px" class="mb-4">
              <img class="appLogo" src="/static/logo.png" alt="App Logo"/>
            </v-avatar>

            <h1 class="title mb-2">Welcome to Funther, engaging therapies</h1>
  ...
  watch: {
    user (value) {
      if (value !== null && value !== undefined) {
        if (value.id === 'r92zoj65tLUboFYojCsw5ekCnI83') {
