                  ...
                  <v-flex d-flex xs12 sm6 md4>
                    <v-card color="blue-grey darken-4" class="white--text">
                      <v-card-title primary-title>
                        <div>
                          <div class="headline">Flexión de Rodilla 3</div>
                          <span>Tumbado boca arriba, flexionar la rodilla hasta 90º (ángulo recto) y luego estirar la pierna de nuevo dejándola en la posición inicial.</span><br>
                          <span>10 repeticiones en el menor tiempo posible</span>
                        </div>
                      </v-card-title>
                      <v-card-media src="/static/videos/rodilla3.gif" height="350">
                      </v-card-media>      
                      <div class="text-xs-center">
                        <v-progress-linear
                          v-model="value"
                    ...
                    <v-layout v-else key="1" justify-center align-center>
                      ...
                      <v-card-media src="/static/rodilla3.png" height="350">
                      </v-card-media>
                            ...
                            <v-card>
                              <v-card-text>
                                <v-alert
                                    ...
                                    transition="scale-transition"
                                  >
                                    Has terminado, ¡Desbloqueaste el tercer track de tu canción!. Dale Play y escuchalo.
                                    <div v-for="item in items"
                                        :key="item.title">
                                      <v-btn v-if="item.isPlaying" flat icon color="blue darken-3" @click="item.isPlaying ? pause(item) : play(item)">
                                          <v-icon>pause_circle_filled</v-icon>           
  ...
  components: {
    VWidget
      ...
      return {
        ...
        counter: 0,
        items: [
          { active: true, title: 'Back in Black', avatar: 'https://cdn.vuetifyjs.com/images/lists/1.jpg', file: new Audio('static/funther_FS2.mp3'),
            isPlaying: false }
        ]
      }
    },
